...
<br> 
     ...
     If you work in education, the inconvenient truth you have to face is that a self-motivated student who knows 
...
* ជំពូកទី ០២\. [រលក](#ជំពូក-០២-រលក) 
    * L.4\. [គោលការណ៍តម្រួតនៃរលក និង រលកជញ្ជ្រំ](#មេរៀនទី-0៤-គោលការណ៍តម្រួតនៃរលក-និង-រលកជញ្ជ្រំ)
    * L.5\. <s> អាំងទែផេរ៉ង់ និង ឌីប្រាក់ស្យុង </s>
* ជំពូកទី ០៣ \. អគ្គិសនី និង ម៉ាញេទិច 
    * L.6\. [ដែន និង កម្លាំងអគ្គិសនី](#មេរៀនទី-០៦-ដែន-និង-កម្លាំងម៉ាញេទិច)
...
* ebook
    ...
    * [សៀវភៅស សង្ខេប ក្រសួងធ្លាប់ចេញប្រលង](#សៀវភៅសម្រាប់ត្រៀមបាក់ឌុប)
    * [វិញ្ញាសារូបវិទ្យា ឆមាស និង បាក់ឌុប(ថ្នាក់វិទ្យាសាស្ត្រពិត-សង្គម) ឆ្នាំ 2011-2019](#កម្រងវិញ្ញាសាបាក់ឌុប-ឆ្នាំ-2011-2019)
    * [វិញ្ញាសាបាក់ឌុបរូបវិទ្យា និង អត្រាកំណែ ឆ្នាំ 2011-2022](#វិញ្ញាសាបាក់ឌុបរូបវិទ្យា-និង-អត្រាកំណែ-ឆ្នាំ-2011-2022) 
    * [អត្រាកំណែផ្លូវការ](#អត្រាកំណែផ្លូវការ-និង-ការឱ្យពិន្ទុ)
    * [រូបមន្តសង្ខេប](#រូបមន្តសង្ខេប-PDF)
    * [កម្រងសំនួរចម្លើយ](#កម្រងសំនួរ-ចម្លើយ)
 * [Sources/Simulations support Teaching & Learning](#Sources-Simulations-support-Teaching-and-Learning)
...
<!--START_SECTION:activity-->
  ...
  -  [វីដេអូភាគទី 1](https://www.youtube.com/watch?v=RH95h36NChI&list=PL85708E6EA236E3DB&index=2) 
  -  [វីដេអូភាគទី 2](https://www.youtube.com/watch?v=9O7y7XEC66M&list=PL85708E6EA236E3DB&index=3)
  -  [វីដេអូភាគទី 3](https://www.youtube.com/watch?v=1xeHh5DnCIw&list=PL85708E6EA236E3DB&index=4)
  -  [វីដេអូភាគទី 4](https://www.youtube.com/watch?v=E9GrOxhYZdQ&list=PL85708E6EA236E3DB&index=5)
  -  [វីដេអូភាគទី 5](https://www.youtube.com/watch?v=-QVRiMkdRsU&list=PL85708E6EA236E3DB&index=6)
...
### មេរៀនទី 0៤ គោលការណ៍តម្រួតនៃរលក និង រលកជញ្ជ្រំ
...
# ជំពូក ០៣ អគ្គិសនី និង ម៉ាញេទិច
     Science is an activity of men; to many men it is a great pleasure and it should not be denied to the people
     of a large part of the world simply because of a fault or lack in the educational system.
...
<br>
     ...
     The value in teaching science is to teach how things are found out.  The value of questioning, the value of 
     free ideas – not only for the development of science, but the value of free ideas in every field – becomes 
     apparent.  Science is a way to teach how something gets to be known, what is not known, to what extent things
     are known (for nothing is known absolutely), how to handle doubt and uncertainty, what the rules of evidence are,
     how to think about things so that judgments can be made, how to distinguish truth from fraud, and from show.
     These are certainly important secondary yields of teaching science, and physics in particular. _ Prof. Feynman
...
**Topics Covered:**  `បាតុភូតអាំងឌុចស្យុងអេឡិចត្រូម៉ាញេទិច` `ភ្លុចម៉ាញេទិច` `បម្រែបម្រួលភ្លុច` `ចរន្តអាំងឌ្វី` `កម្លាំងអគ្គិសនីចលករអាំងឌ្វី ឬ តង់ស្យុង` `ច្បាប់ផារ៉ាដេ` `ច្បាប់ឡិន` `ចរន្តអេឌី` `ជនិតា` `ម៉ូទ័រអគ្គិសនី`
<br>
**Maths Prerequisites:** 
- វីដេអូ ពន្យល់ ខ្លឹមសារមេរៀន ៖
...
**Topics Covered:** `បាតុភូតអូតូអាំងឌុចស្យុង` `អាំងឌុចតង់` `កម្លាំងអគ្គិសនីចលករអូតូអាំងឌ្វី` `ថាមពលម៉ាញេទិច` `ថេរពេល` $\tau$ `សៀគ្វី RL` `ឌីប៉ូល RL ពេលបិទកុងតាក់`
$i = I_p(1-e^\frac{-t}{\tau})$ `ចរន្តក្នុងរបបអចិន្ត្រៃយ៍` $i = I_p = \frac{E}{R}$ `ឌីប៉ូល RL ពេលចំហកុងតាក់` $i = I_p e^\frac{-t}{\tau}$   
`សៀគ្វីលំយោល LC` `ច្បាប់រក្សាថាមពល` `ខួបនៃលំយោល`  
<br>
...
###### (ធានា បាន A+ រូបវិទ្យា) 
- [🅰️ 1. សៀវភៅសង្ខេបក្រសួង  ធ្លាប់ដកស្រង់លំហាត់ ចេញប្រលង ឆ្នាំ 2015-2016-2017-2018-2019-2021](https://drive.google.com/file/d/1_LNpf0rKgL4Fm4aqaJsKFIlEM600X89o/view?usp=sharing) `58 ទំព័រ` `Bible Bacc -II Physics` `Complete this book A+ is calling`
- [📘 2. រូបវិទ្យាថ្នាក់ទី ១២ រៀបរៀងដោយ ក្រុមនិស្សិតស្ម័គ្រចិត្ត ក្រសួងអប់រំ យុវជន និង កីឡា](https://drive.google.com/file/d/1iST2r4s6t9v42luGsnGR7jGB7yMSJ_C3/view?usp=sharing) `មានសម្រាយដំណោះស្រាយពិស្តារ ដោយយកលំហាត់ពីសៀវភៅសង្ខេបក្រសួង 58 ទំព័រ ខាងលើ`
- [3. សៀវភៅ កម្រង_វិញ្ញាសា_រូបវិទ្យា រៀបចំដោយក្រសួង អប់រំ](https://drive.google.com/file/d/18bXIVBnLzEc07jDadFDf7MVTlx4BxtBq/view?usp=sharing)

#### កម្រងវិញ្ញាសាបាក់ឌុប ឆ្នាំ 2011-2019
...
#### វិញ្ញាសាបាក់ឌុបរូបវិទ្យា និង អត្រាកំណែ ឆ្នាំ 2011-2022 
...
#### កម្រងសំនួរ ចម្លើយ
- [កម្រងសំនួរ រូបវិទ្យា ថ្នាក់ទី ១២](https://drive.google.com/file/d/1pJ9WWEYA_zGKOLlIrGsJDGYtsqOeSLva/view?usp=sharing)
- [59 សំនួរ-ចម្លើយ រូបវិទ្យាសម្រាប់ត្រៀមប្រលងបាក់ឌុប](https://drive.google.com/file/d/1Q3-o5CrCO2nHiMuTPoL-YQMt5l3sK7ZX/view?usp=sharing)

-----

#  Sources Simulations support Teaching and Learning 
...
**ឆ្នាំទី_១ និង ទី_២**
- [Pauls Online Math Notes](https://tutorial.math.lamar.edu/) `Algebra`, `Calculus I`, `Calculus II`, `Calculus III` and `Differential Equations`
