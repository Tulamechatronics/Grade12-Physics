...
**Topics Covered:** `បាតុភូតអូតូអាំងឌុចស្យុង` `អាំងឌុចតង់` `កម្លាំងអគ្គិសនីចលករអូតូអាំងឌ្វី` `ថាមពលម៉ាញេទិច` `សៀគ្វី RL` `ឌីប៉ូល RL ពេលបិទកុងតាក់` $ i = I_p(1-e^-\frac{t}{\tau}$ `ថេរពេល` ($\tau$)  `សៀគ្វីលំយោល LC` `ច្បាប់រក្សាថាមពល` `ខួបនៃលំយោល`  
<br>
**Maths Prerequisites:** 
- វីដេអូ ពន្យល់ ខ្លឹមសារមេរៀន ៖
